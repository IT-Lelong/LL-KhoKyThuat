...
import com.lelong.ll_khokythuat.QR210.Main.qr210;
import com.lelong.ll_khokythuat.QR211.qr211;
...
public class Menu extends AppCompatActivity {
    ...
    Button btn_QR210, btn_QR211, btn_KT03, btn_KT04;
    TextView menuID;
    String ID;
    Locale locale;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_QR210 = findViewById(R.id.btn_QR210);
        btn_QR211 = findViewById(R.id.btn_QR211);

        btn_QR210.setOnClickListener(btnlistener);
        btn_QR211.setOnClickListener(btnlistener);
